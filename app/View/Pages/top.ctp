...
<div class="container">
    <div class="row">
        ...
        <?php echo $this->Form->create('Company', array('action' => 'login')); ?>
            <h4>Please sign in.</h4>
                <?php echo $this->Form->text('Company.mail', array('class' => 'form-control', 'label' => false, 'placeholder' => "username")); ?>
            </br>
                <?php echo $this->Form->password('Company.password', array('class' => 'form-control', 'label' => false, 'placeholder' => "password")); ?>
            </br>
            <div class="wrapper">
